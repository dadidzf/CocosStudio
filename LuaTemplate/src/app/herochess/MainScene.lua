...
function MainScene:onCreate()
	...
	dd.NetworkClient:connect("192.168.0.106", 8080)
	ccui.Text:create("Login", "", fntSize)
		...
		:onClick(function ()
			print("Login -- ")
			dd.NetworkClient:send("login.login", {acount = "123456", passwd = "123456"}, function ( ... )
	...
	ccui.Text:create("Register", "", fntSize)
		...
		:onClick(function ()
			print("Register --")
			dd.NetworkClient:send("login.login", {acount = "123456", passwd = "123456"})
		end)
